...
{
    public partial class FactoryNameController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public FactoryNameController() { }

        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected FactoryNameController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public FactoryNameController Actions { get { return MVC.Administrator.FactoryName; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Administrator";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "FactoryName";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "FactoryName";
        ...
        public class ViewsClass
        {
            ...
            public readonly string Create = "~/Areas/Administrator/Views/FactoryName/Create.cshtml";
            public readonly string Delete = "~/Areas/Administrator/Views/FactoryName/Delete.cshtml";
            public readonly string Index = "~/Areas/Administrator/Views/FactoryName/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class T4MVC_FactoryNameController : OPS.Areas.Administrator.Controllers.FactoryNameController
    {
        public T4MVC_FactoryNameController() : base(Dummy.Instance) { }
