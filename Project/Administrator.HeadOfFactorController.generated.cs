...
namespace OPS.Areas.Administrator.Controllers
{
    public partial class HeadOfFactorController
    {
        ...
        public HeadOfFactorController() { }

        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected HeadOfFactorController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public HeadOfFactorController Actions { get { return MVC.Administrator.HeadOfFactor; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Administrator";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "HeadOfFactor";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "HeadOfFactor";
        ...
        public class ActionNamesClass
        {
            ...
            public readonly string GetHeadOfFactors = "GetHeadOfFactors";
        ...
        public class ActionNameConstants
        {
            ...
            public const string GetHeadOfFactors = "GetHeadOfFactors";
        ...
        public class ActionParamsClass_Create
        {
            ...
            public readonly string headoffactor = "headoffactor";
        }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ActionParamsClass_GetSubHeadLines GetSubHeadLinesParams { get { return s_params_GetSubHeadLines; } }
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public class ActionParamsClass_GetSubHeadLines
        {
            public readonly string HeadLineId = "HeadLineId";
        }
        ...
        public class ViewsClass
        {
            ...
            public readonly string Create = "~/Areas/Administrator/Views/HeadOfFactor/Create.cshtml";
            public readonly string Delete = "~/Areas/Administrator/Views/HeadOfFactor/Delete.cshtml";
            public readonly string Details = "~/Areas/Administrator/Views/HeadOfFactor/Details.cshtml";
            public readonly string Edit = "~/Areas/Administrator/Views/HeadOfFactor/Edit.cshtml";
            public readonly string Index = "~/Areas/Administrator/Views/HeadOfFactor/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class T4MVC_HeadOfFactorController : OPS.Areas.Administrator.Controllers.HeadOfFactorController
    {
        public T4MVC_HeadOfFactorController() : base(Dummy.Instance) { }
        ...
        public override System.Web.Mvc.JsonResult GetHeadOfFactors()
        {
            var callInfo = new T4MVC_JsonResult(Area, Name, ActionNames.GetHeadOfFactors);
            return callInfo;
        }

        public override System.Web.Mvc.ActionResult Create(string Code)
        {
        ...
        public override System.Web.Mvc.ActionResult Create(ViewModels.Areas.Administrator.HeadOfFactor.CreateViewModel headoffactor)
        {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.Create);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "headoffactor", headoffactor);
            return callInfo;
        }
        ...
        public override System.Web.Mvc.ActionResult Edit(ViewModels.Areas.Administrator.HeadOfFactor.EditViewModel headoffactor)
        {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "headoffactor", headoffactor);
            return callInfo;
        ...
        public override System.Web.Mvc.ActionResult GetSubHeadLines(System.Guid HeadLineId)
        {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.GetSubHeadLines);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "HeadLineId", HeadLineId);
            return callInfo;
        }
