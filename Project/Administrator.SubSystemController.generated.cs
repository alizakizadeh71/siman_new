...
{
    public partial class SubSystemController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public SubSystemController() { }

        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected SubSystemController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public SubSystemController Actions { get { return MVC.Administrator.SubSystem; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Administrator";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "SubSystem";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "SubSystem";
        ...
        public class ActionNamesClass
        {
            ...
            public readonly string GetSubSystems = "GetSubSystems";
        ...
        public class ActionNameConstants
        {
            ...
            public const string GetSubSystems = "GetSubSystems";
        ...
        public class ViewsClass
        {
            ...
            public readonly string Create = "~/Areas/Administrator/Views/SubSystem/Create.cshtml";
            public readonly string Delete = "~/Areas/Administrator/Views/SubSystem/Delete.cshtml";
            public readonly string Detail = "~/Areas/Administrator/Views/SubSystem/Detail.cshtml";
            public readonly string Edit = "~/Areas/Administrator/Views/SubSystem/Edit.cshtml";
            public readonly string Index = "~/Areas/Administrator/Views/SubSystem/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class T4MVC_SubSystemController : OPS.Areas.Administrator.Controllers.SubSystemController
    {
        public T4MVC_SubSystemController() : base(Dummy.Instance) { }
        ...
        public override System.Web.Mvc.JsonResult GetSubSystems()
        {
            var callInfo = new T4MVC_JsonResult(Area, Name, ActionNames.GetSubSystems);
            return callInfo;
        }
        ...
        public override System.Web.Mvc.ActionResult Create(ViewModels.Areas.Administrator.SubSystem.CreateViewModel subsystem)
        {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.Create);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "subsystem", subsystem);
            return callInfo;
        }
        ...
        public override System.Web.Mvc.ActionResult Edit(ViewModels.Areas.Administrator.SubSystem.EditViewModel subsystem)
        {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "subsystem", subsystem);
            return callInfo;
