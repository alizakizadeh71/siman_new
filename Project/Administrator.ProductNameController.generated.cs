...
{
    public partial class ProductNameController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ProductNameController() { }

        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected ProductNameController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ProductNameController Actions { get { return MVC.Administrator.ProductName; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Administrator";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "ProductName";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "ProductName";
        ...
        public class ViewsClass
        {
            ...
            public readonly string Create = "~/Areas/Administrator/Views/ProductName/Create.cshtml";
            public readonly string Delete = "~/Areas/Administrator/Views/ProductName/Delete.cshtml";
            public readonly string Index = "~/Areas/Administrator/Views/ProductName/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class T4MVC_ProductNameController : OPS.Areas.Administrator.Controllers.ProductNameController
    {
        public T4MVC_ProductNameController() : base(Dummy.Instance) { }
