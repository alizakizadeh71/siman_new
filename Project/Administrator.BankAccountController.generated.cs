...
namespace OPS.Areas.Administrator.Controllers
{
    public partial class BankAccountController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public BankAccountController Actions { get { return MVC.Administrator.BankAccount; } }
        ...
        public class ActionNamesClass
        {
            ...
            public readonly string GetBankAccounts = "GetBankAccounts";
        ...
        public class ViewsClass
        {
            ...
            public readonly string Create = "~/Areas/Administrator/Views/BankAccount/Create.cshtml";
            public readonly string Delete = "~/Areas/Administrator/Views/BankAccount/Delete.cshtml";
            public readonly string Detail = "~/Areas/Administrator/Views/BankAccount/Detail.cshtml";
            public readonly string Edit = "~/Areas/Administrator/Views/BankAccount/Edit.cshtml";
            public readonly string Index = "~/Areas/Administrator/Views/BankAccount/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class T4MVC_BankAccountController : OPS.Areas.Administrator.Controllers.BankAccountController
    {
        ...
        public override System.Web.Mvc.ActionResult Search(ViewModels.Areas.Administrator.BankAccount.SearchViewModel viewModel)
        {
        ...
        public override System.Web.Mvc.JsonResult GetBankAccounts()
        {
            var callInfo = new T4MVC_JsonResult(Area, Name, ActionNames.GetBankAccounts);
            return callInfo;
        }
        ...
        public override System.Web.Mvc.ActionResult Create(ViewModels.Areas.Administrator.BankAccount.CreateViewModel BankAccount)
        {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.Create);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "BankAccount", BankAccount);
            return callInfo;
        }
        ...
        public override System.Web.Mvc.ActionResult Edit(ViewModels.Areas.Administrator.BankAccount.EditViewModel BankAccount)
        {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "BankAccount", BankAccount);
            return callInfo;
