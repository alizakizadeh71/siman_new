...
{
    public partial class SubHeadLineController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public SubHeadLineController() { }

        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected SubHeadLineController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public SubHeadLineController Actions { get { return MVC.Administrator.SubHeadLine; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Administrator";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "SubHeadLine";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "SubHeadLine";
        ...
        {
            public readonly string SubHeadLine = "SubHeadLine";
        }
        ...
        public class ViewsClass
        {
            ...
            public readonly string Create = "~/Areas/Administrator/Views/SubHeadline/Create.cshtml";
            public readonly string Delete = "~/Areas/Administrator/Views/SubHeadline/Delete.cshtml";
            public readonly string Detail = "~/Areas/Administrator/Views/SubHeadline/Detail.cshtml";
            public readonly string Edit = "~/Areas/Administrator/Views/SubHeadline/Edit.cshtml";
            public readonly string Index = "~/Areas/Administrator/Views/SubHeadline/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class T4MVC_SubHeadLineController : OPS.Areas.Administrator.Controllers.SubHeadLineController
    {
        public T4MVC_SubHeadLineController() : base(Dummy.Instance) { }
        ...
        public override System.Web.Mvc.JsonResult GetSubHeadLines()
        {
            var callInfo = new T4MVC_JsonResult(Area, Name, ActionNames.GetSubHeadLines);
            return callInfo;
        }
        ...
        public override System.Web.Mvc.ActionResult Create(ViewModels.Areas.Administrator.SubHeadLine.CreateViewModel SubHeadLine)
        {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.Create);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "SubHeadLine", SubHeadLine);
            return callInfo;
        }
        ...
        public override System.Web.Mvc.ActionResult Edit(ViewModels.Areas.Administrator.SubHeadLine.EditViewModel SubHeadLine)
        {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "SubHeadLine", SubHeadLine);
            return callInfo;
